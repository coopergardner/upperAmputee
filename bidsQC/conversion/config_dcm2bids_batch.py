...
path_toplevel = os.path.join(os.sep, "projects", "motorskill", "shared", "upperAmputee") # folder that contains path_bidsdata and path_conversionfolder
path_dicoms = os.path.join(os.sep, "projects", "motorskill", "shared", "upperAmputee", "Dicom_edited")
...
singularity_image = os.path.join(os.sep, "projects", "motorskill", "shared", "containers", singularity_image) # Set equal to "NA" if you are running the script locally
...
path_bidsdata = os.path.join(os.sep, "projects", group, "shared", "upperAmputee", "bids_data") # Where the niftis will be put
