...
group = "motorskill" # This is the name of the group on Talapas to which your account belongs
...
# Test subject
test_subject = "0002062" # Name of a directory that contains DICOMS for one participant. Must be subfolder of pathToDicomsFolder. E.g. pathToDicomsFolder/S001
